...
echo "<section id=\"formulario\"><form action=\"/insertarDatos.php\" method=\"post\">Nombre:<br><input id=\"ipcorto\" type=\"text\" name=\"nombre\" value=\"Su Nombre\"><br>Apellidos:<br><input id=\"ipcorto\" type=\"text\" name=\"apellidos\" value=\"Sus Apellidos\"><br>Alias:<br><input id=\"ipcorto\" type=\"text\" name=\"alias\" value=\"Su Alias\"><br>Comentario:<br><textarea id=\"iplargo\" rows=\"5\" type=\"text\" name=\"comentario\" value=\"Comentario\"></textarea><br><br><input id=\"comentar\"  type=\"submit\" value=\"Comentar\"></form></section>";
